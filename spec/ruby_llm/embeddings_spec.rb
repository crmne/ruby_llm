...
RSpec.describe RubyLLM::Embedding do
  ...
  describe 'basic functionality' do
    [
      ...
      it "#{model} can handle a single text with custom dimensions" do # rubocop:disable RSpec/MultipleExpectations
      ...
      it "#{model} can handle multiple texts with custom dimensions" do # rubocop:disable RSpec/MultipleExpectations
