...
<section class="home-section home-band home-models-section">
  <div class="home-section-inner">
    ...
    <div class="provider-icons" aria-label="Supported AI providers">
      ...
      <a href="https://ollama.com/cloud" target="_blank" rel="noreferrer" class="provider-logo"><img src="{{ '/assets/images/providers/ollama.svg' | relative_url }}" alt="Ollama Cloud" class="logo-mark"><img src="{{ '/assets/images/providers/ollama-text.svg' | relative_url }}" alt="" class="logo-text"><span class="logo-suffix">Cloud</span></a>
