...
Apps upgrading from 1.16 get `cache_until_here` from the [2.0 upgrade](https://rubyllm.com/v2.0/upgrading/). New apps get the column from the install generator.
