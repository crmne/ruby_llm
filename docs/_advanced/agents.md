...
* `safety_identifier` (see [Request Control]({% link _core_features/chat-request-control.md %}#identifying-end-users))
...
* `with_model`, `with_temperature`, `with_thinking`, `with_citations`, `with_safety_identifier`, `with_context`
