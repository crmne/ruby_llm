...
*   [Durable agents with background jobs]({% link _advanced/agentic-workflows.md %}#driving-the-loop-yourself) - run each agent turn as its own job and survive deploys with ActiveJob Continuations.
