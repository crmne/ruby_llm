...
require 'open3'
require 'stringio'
require 'ruby_llm/provider_generator/scaffold'

module RubyLLM
  module ProviderGenerator # :nodoc: all
    ...
    class CLI # :nodoc: all
      ...
      def parse_provider_options(mode:)
        ...
        parser.on('--dialect NAME', "Wire dialect: #{Scaffold::SUPPORTED_DIALECTS.join(', ')}") do |value|
      ...
      def generate_provider_gem
        ...
        scaffold = Scaffold.new(name, **options)
